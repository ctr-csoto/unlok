...
```bash
  npm i aws-sdk @hapi/boom bcrypt cors dotenv express fluent-ffmpeg @ffmpeg-installer/ffmpeg jimp joi jsonwebtoken knex mkdirp morgan multer mysql npm sequelize cli sharp sqlite3 winston
  npm i nodemon -D
```
